...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_LCTRL, MO(_FN1),KC_LALT,    KC_TAB,  KC_QUOT,  KC_SPC,     KC_BSLS, KC_COMM, KC_DOT,  KC_SLSH
    ),
    [_FN1] = LAYOUT(
    ...
    [_FN2] = LAYOUT(
        _______,  _______, _______,    _______, _______,  _______,    _______, _______, _______, _______,
        _______,  _______, EEP_RST,    RESET,   _______,  _______,    _______, _______, _______, _______,
