...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [_WIN] = LAYOUT_103key_iso(
            KC_ESC,  KC_ESC,                   KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL,        KC_BSPC,    KC_INS,  KC_HOME, KC_PGUP,    TG(1),   KC_PSLS, KC_PAST, KC_PMNS, \
            ...
            _______, _______,                  KC_LCTL, KC_LGUI, KC_LALT,                      KC_SPC                    , KC_RALT, KC_RGUI, MO(2),    KC_LEFT, KC_DOWN, KC_RGHT,             KC_P0,   KC_PDOT
        ),
        [_MAC] = LAYOUT_103key_iso(
            ...
            PREV_WORKSPACE, NEXT_WORKSPACE,   KC_LCTL, KC_LALT, KC_LGUI,                                  KC_SPC                             , KC_RGUI, KC_RALT, MO(2),                 _______, _______, _______,             _______, _______
        ),
        [_FN] = LAYOUT_103key_iso(
            ...
            _______, _______,      _______,      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______,    _______, _______, _______, \
            _______, _______,      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,             _______, _______, _______,    _______, _______, _______, _______, \
            _______, _______,      _______, _______, _______,                              MO(3)                              , _______, _______, _______,                   _______, _______, _______,             _______, _______
        ),
