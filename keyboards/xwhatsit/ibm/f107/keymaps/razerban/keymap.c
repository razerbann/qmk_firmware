...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [_WIN] = LAYOUT_103key_iso(
            ...
            _______, _______,                  KC_LCTL, KC_LGUI, KC_LALT,                      KC_SPC                    , KC_RALT, KC_RGUI, MO(_FN1), KC_LEFT, KC_DOWN, KC_RGHT,             KC_P0,   KC_PDOT
        ),
        [_MAC] = LAYOUT_103key_iso(
            ...
            PREV_WORKSPACE, NEXT_WORKSPACE,   KC_LCTL, KC_LALT, KC_LGUI,                                  KC_SPC                             , KC_RGUI, KC_RALT, _______,               _______, _______, _______,             _______, _______
        ),
        [_FN1] = LAYOUT_103key_iso(
        ...
        [_FN2] = LAYOUT_103key_iso(
            ...
            _______, _______,      _______,    _______, _______, EEP_RST, RESET,   _______, _______, _______, _______, _______, _______, _______, _______,                   _______, _______, _______,    _______, _______, _______, _______, \
