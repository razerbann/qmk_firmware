...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_WIN] = LAYOUT_122key(
        ...
        _______, _______,                   KC_LGUI,         KC_LALT,                     KC_SPC ,                                           KC_RALT,         MO(_FN1),                     KC_DOWN,                      KC_P0  , KC_PDOT
    ),
    [_MAC] = LAYOUT_122key(
        ...
        PREV_WORKSPACE, NEXT_WORKSPACE,     KC_LALT,          KC_LGUI,                     _______,                                           _______,         _______,                     _______,                      _______, _______
    ),
    [_FN1] = LAYOUT_122key(
                           _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                           _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
