...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_WIN] = LAYOUT_122key(
        ...
        _______, _______,                   KC_LGUI,         KC_LALT,                     KC_SPC ,                                           KC_RALT,         MO(2),                        KC_DOWN,                      KC_P0  , KC_PDOT
    ),
    [_MAC] = LAYOUT_122key(
        ...
        PREV_WORKSPACE, NEXT_WORKSPACE,     KC_LALT,          KC_LGUI,                     _______,                                           KC_RALT,         MO(2),                       _______,                      _______, _______
    ),
    [_FN] = LAYOUT_122key(
                           _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                           _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [_FN2] = LAYOUT_122key(
        ...
        _______, _______,    _______,    _______, HPT_TOG, DEBUG  , _______, _______, _______, _______, _______, _______, _______, _______, _______,                         _______,             _______, _______, _______, _______,
        _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______,         _______, _______, _______,    _______, _______, _______, _______,
