...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN] = LAYOUT_all(
        ...
        _______, _______,                   KC_LGUI,           KC_LALT,                 KC_SPC ,                                              KC_RALT,            MO(_FN1),            KC_P0  , KC_P0  , KC_PDOT, KC_PENT
    ),
    [_MAC] = LAYOUT_all(
        ...
        PREV_WORKSPACE, NEXT_WORKSPACE,     KC_LALT,           KC_LGUI,                 _______,                                              KC_RALT,            _______,             _______, _______, _______, _______
    ),
    [_FN1] = LAYOUT_all(
