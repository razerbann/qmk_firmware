...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
    [_WIN] = LAYOUT_all(
        KC_ESC,  KC_ESC,                    KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL , KC_BSLS, KC_BSPC,     TG(1)  , KC_PSLS, KC_PAST, KC_PMNS,
        ...
        _______, _______,                   KC_LGUI,           KC_LALT,                 KC_SPC ,                                              KC_RALT,              MO(2),             KC_P0  , KC_P0  , KC_PDOT, KC_PENT
    ),
    [_MAC] = LAYOUT_all(
        ...
        PREV_WORKSPACE, NEXT_WORKSPACE,     KC_LALT,           KC_LGUI,                 _______,                                              KC_RALT,              MO(2),             _______, _______, _______, _______
    ),
    [_FN] = LAYOUT_all(
        ...
        _______, _______,   _______,      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         _______, _______, _______, _______,
        _______, _______,   _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,           _______, _______, _______, _______,
        _______, _______,   _______,           _______,                   MO(4),                                              _______,              _______,           _______, _______, _______, _______
    ),
    [_FN2] = LAYOUT_all(
        _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______,
        _______, _______,   _______,     _______,_______,EEPROM_RESET,RESET, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______,
