...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
    [_WIN] = LAYOUT(
        TO(_MAC), KC_ESC,                  KC_GRV,        KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC,           KC_HOME, KC_END,
        PREV_TAB, NEXT_TAB,                KC_TAB,           KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS,       KC_INS,  KC_DEL,
        PREV_WINDOW_WIN, NEXT_WINDOW_WIN,  KC_LCTRL,            KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT,  KC_UP,   KC_DOWN,
